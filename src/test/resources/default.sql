...
insert into channel_master (channel_id, channel_name) values ('1393571766462316554','web同期');
INSERT INTO chat_message (discord_message_id,quote_discord_id,quote_id,name,message,create_date,channel_master_id) VALUES
	 ('10000',NULL,NULL,'test用bot','ボットさんの発言：<br>ボット起動','2025/07/30 09:03:56',1),
	 ('10001',NULL,NULL,'サテライザー','サテライザーさんの発言：<br>テスト','2025/07/15 03:09:45',1),
	 ('10002',NULL,NULL,'サテライザー','こっちに書いたらどうなるかテスト','2025/07/15 06:32:35',1);
