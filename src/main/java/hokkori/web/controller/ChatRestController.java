...
import hokkori.web.dto.ChatAttachmentDto;
import hokkori.web.dto.ChatMessageDto;
import hokkori.web.dto.MessageSizeDto;
import hokkori.web.entity.ChatMessageView;
import hokkori.web.form.MessageForm;
...
//		messageSizeDto.setSize(chatService.getChatMessageDtoList(channelId).size());
	...
	private ChatMessageDto toChatMessageDtoFromForm(MessageForm messageForm) {
		...
		chatMessageDto.setCreateDate(HokkoriWebApplication.sdf.format(new Date()));
