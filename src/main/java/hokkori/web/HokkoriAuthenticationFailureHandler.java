...
@Component
public class HokkoriAuthenticationFailureHandler implements AuthenticationFailureHandler {
	Logger log = LoggerFactory.getLogger(HokkoriAuthenticationFailureHandler.class);
